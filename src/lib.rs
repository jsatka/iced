...
pub mod isolated_layer {
    ...
    pub use iced_widget::isolated_layer::{
        AlphaMask, Blur, CacheKeepAliveScope, Context, DropShadow, DualKawaseBlur, Effect,
        EffectStack, GaussianBlur, IsolatedLayer, LayerEffect, LayerInputEvidence,
        LayerInputRecords, Pass, Pipeline, PipelineRegistry, Plan, Requirements, ScratchAllocator,
        ScratchError, ScratchTexture, TextureViews,
    };
}
